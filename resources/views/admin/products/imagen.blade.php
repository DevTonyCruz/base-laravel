...
<div class="col-lg-6">
    <div class="card">
        <div class="card-body">
            ...
            <form class="form-horizontal" action="{{ url('admin/products/images') }}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                @csrf

                <div class="form-group row mb-3">
                    <label for="position" class="col-3 col-form-label">Posición</label>
                    <div class="col-9">
                        <select class="form-control{{ $errors->has('position') ? ' is-invalid' : '' }} select2" id="position" name="position" data-toggle="select2">
