...
<div class="col-lg-6">
    <div class="card">
        <div class="card-body">
            ...
            <form class="form-horizontal" action="{{ url('admin/products/') }}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                @csrf
                <div class="form-group row mb-3">
                    <label for="sku" class="col-3 col-form-label">SKU</label>
                    <div class="col-9">
                        <input type="text" class="form-control{{ $errors->has('sku') ? ' is-invalid' : '' }}" id="sku" name="sku" placeholder="Ingrese su nombre" value="{{ old('sku') }}" required>
                        @if ($errors->has('sku'))
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-9">
                        <textarea type="text" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" id="description" name="description" placeholder="Ingrese una descripción">{{ old('description') }}</textarea>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-9">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Ingrese el precio" id="price" name="price" aria-label="precio" aria-describedby="price-addon" value="{{ old('price') }}" require>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-9">
                        <input type="text" class="form-control{{ $errors->has('initial') ? ' is-invalid' : '' }}" id="initial" name="initial" placeholder="Ingrese el stock inicial" value="{{ old('initial') }}">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-9">
                        <input type="text" class="form-control{{ $errors->has('minimum') ? ' is-invalid' : '' }}" id="minimum" name="minimum" placeholder="Ingrese el stock mínimo" value="{{ old('minimum') }}">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-9">
                        <input type="text" class="form-control{{ $errors->has('maximum') ? ' is-invalid' : '' }}" id="maximum" name="maximum" placeholder="Ingrese el stock máximo" value="{{ old('maximum') }}">
