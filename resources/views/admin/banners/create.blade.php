            ...
            <div class="card-body">
                ...
                <form class="form-horizontal" id="form-banner-admin" action="{{ url('admin/banners/') }}" method="POST"
                    ...
                    <div class="form-group row mb-3">
                        <label for="type" class="col-3 col-form-label">Tipo de banner</label>
                        <div class="col-9">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <input type="text"
                                    ...
                                    id="button_text" name="button_text" placeholder="Ingrese el texto del botón"
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <textarea type="text"
                                    ...
                                    placeholder="Ingrese el contenido">{{ old('content') }}</textarea>
                            ...
                            <div class="col-9 form-row align-items-center ">
                                <div class="col-auto">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="izquierda" name="position" class="custom-control-input"
                                            value="izquierda" checked>
                                        <label class="custom-control-label" for="izquierda">Izquierda</label>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="centro" name="position" class="custom-control-input"
                                            value="centro">
                                ...
                                <div class="col-auto">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="derecha" name="position" class="custom-control-input"
                                            value="derecha">
