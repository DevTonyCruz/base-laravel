        ...
        <div class="auth-fluid">
                ...
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                        ...
                        <footer class="footer footer-alt">
                            <p class="text-muted">Dont have an account? <a href="pages-register-2.html" class="text-muted ml-1"><b>Sign Up</b></a></p>
                        </footer>
            ...
            <div class="auth-fluid-right text-center">
                <div class="auth-user-testimonial">
                    ...
                    <p class="lead"><i class="mdi mdi-format-quote-open"></i> Its a elegent templete. I love it very much! . <i class="mdi mdi-format-quote-close"></i>
                    </p>
                    <p>
                        - Hyper Admin User
                    </p>
