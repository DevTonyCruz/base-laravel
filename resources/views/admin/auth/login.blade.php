    ...
    <div class="align-items-center d-flex h-100">
        <div class="card-body">
            ...
            <form action="{{ route('admin.login') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    @if (Route::has('admin.password.request'))
                        <a href="{{ route('admin.password.request') }}" class="text-muted float-right"><small>¿Olvidaste tú contraseña?</small></a>
                    @endif
            ...
            <footer class="footer footer-alt">
                <p class="text-muted">¿No tienes una cuenta? <a href="{{ route('admin.register') }}" class="text-muted ml-1"><b>Regístrate</b></a></p>
            </footer>
            @endif
