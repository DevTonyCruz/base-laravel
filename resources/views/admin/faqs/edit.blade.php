        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" action="{{ url('admin/faqs/' . $faq->id) }}" method="POST">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-9">
                        <select class="form-control{{ $errors->has('topic') ? ' is-invalid' : '' }} select2" id="topic" name="topic" data-toggle="select2">
                            <option value="S">Seleccionar</option>

                            @foreach ($faqsCategory as $faqCategory)
                            <option value="{{ $faqCategory->id }}" {{ ($faq->faq_category_id == $faqCategory->id ? "selected":"") }}>{{ $faqCategory->title }}</option>
                            @endforeach
                        </select>
                        @if ($errors->has('topic'))
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-9">
                        <input type="text" class="form-control{{ $errors->has('question') ? ' is-invalid' : '' }}" id="question" name="question" placeholder="Ingrese la pregunta" value="{{ $faq->question }}" required>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-9">
                        <textarea type="text" class="form-control wyswyg-content{{ $errors->has('answer') ? ' is-invalid' : '' }}" id="answer" name="answer" placeholder="Ingrese la respuesta">{!! $faq->answer !!}</textarea>
