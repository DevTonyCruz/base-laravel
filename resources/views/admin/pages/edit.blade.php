        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" action="{{ url('admin/pages/' . $page->id) }}" method="POST">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-9">
                        <input type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" id="title" name="title" placeholder="Ingrese el titulo" value="{{ $page->title }}" required>
                        @if ($errors->has('title'))
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-9">
                        <input type="text" class="form-control{{ $errors->has('slug') ? ' is-invalid' : '' }}" id="slug" name="slug" placeholder="Ingrese el slug" value="{{ $page->slug }}" required>
                        @if ($errors->has('slug'))
                            <span class="invalid-feedback" role="alert">
